...
// 		SourceCh:        sourceCh,
// 		Recorder:        recorder,
// 		StreamSecretEvents: func(ctx context.Context, obj ctrlclient.Object, _ websocket.MessageType, _ []byte) error {
// 			select {
...
// 		return len(globalDispatcher.listeners) == 1
// 	}, time.Second, 10*time.Millisecond)

// 	dispatcherMu.Lock()
// 	ch := globalDispatcher.listeners[0].ch
// 	dispatcherMu.Unlock()

// 	ch <- eventMessage{msgType: websocket.MessageText, data: []byte(`{}`)}
...
// 	for i := 0; i < instantUpdateErrorThreshold; i++ {
// 		ch <- eventMessage{msgType: websocket.MessageText, data: []byte(`{}`)}
// 	}
