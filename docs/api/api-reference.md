...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `instantUpdates` _boolean_ | InstantUpdates is a flag to indicate that event-driven updates are<br />enabled for a VaultDynamicSecret |  |  |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `instantUpdates` _boolean_ | InstantUpdates is a flag to indicate that event-driven updates are<br />enabled for a VaultStaticSecret |  |  |
...
| `syncConfig` _[DyanmicSecretSyncConfig](#dyanmicsecretsyncconfig)_ | SyncConfig configures sync behavior from Vault to VSO |  |  |
