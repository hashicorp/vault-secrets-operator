...
<!-- DO NOT EDIT. The docs below are generated automatically. To change, edit
                  the vault-secrets-operator repo's values.yaml file -->
<!-- codegen: start -->
...
- `defaultAuthMethod` ((#v-defaultauthmethod)) - Configures and deploys the default VaultAuthMethod CR which will be used by resources
  ...
  * It is strongly recommended to deploy the vault secrets operator in a secure Vault environment
  ...
  - `storageEncryption` ((#v-defaultauthmethod-storageencryption)) - StorageEncryption provides the necessary configuration to encrypt the client storage
    ...
    - `enabled` ((#v-defaultauthmethod-storageencryption-enabled)) (`boolean: false`)

    - `keyName` ((#v-defaultauthmethod-storageencryption-keyname)) (`string: ""`) - KeyName to use for encrypt/decrypt operations via Vault Transit.

    - `mount` ((#v-defaultauthmethod-storageencryption-mount)) (`string: ""`) - Mount path of the Transit engine in Vault.
...
such as [kustomize](https://github.com/kubernetes-sigs/kustomize) using the `configs/` path in the repository.
