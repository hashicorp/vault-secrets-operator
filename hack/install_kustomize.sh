...
# Copied from: https://github.com/kubernetes-sigs/kustomize/blob/master/hack/install_kustomize.sh
# Added support authenticating GitHub API requests when GITHUB_TOKEN env is set.
