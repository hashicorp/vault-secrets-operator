...
func (in *SecretTransformationSpec) DeepCopyInto(out *SecretTransformationSpec) {
	*out = *in
	if in.TemplateSpecs != nil {
		...
		*out = make(map[string]TemplateSpec, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TemplateSpecRef) DeepCopyInto(out *TemplateSpecRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TemplateSpecRef.
func (in *TemplateSpecRef) DeepCopy() *TemplateSpecRef {
	if in == nil {
		return nil
	}
	out := new(TemplateSpecRef)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TransformationRef) DeepCopyInto(out *TransformationRef) {
	*out = *in
	if in.TemplateRefSpecs != nil {
		in, out := &in.TemplateRefSpecs, &out.TemplateRefSpecs
		*out = make(map[string]TemplateSpecRef, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
