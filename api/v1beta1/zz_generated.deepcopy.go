...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TemplateSpecBase) DeepCopyInto(out *TemplateSpecBase) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TemplateSpecBase.
func (in *TemplateSpecBase) DeepCopy() *TemplateSpecBase {
	if in == nil {
		return nil
	}
	out := new(TemplateSpecBase)
	in.DeepCopyInto(out)
	return out
}
