...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VaultStaticMeta) DeepCopyInto(out *VaultStaticMeta) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VaultStaticMeta.
func (in *VaultStaticMeta) DeepCopy() *VaultStaticMeta {
	if in == nil {
		return nil
	}
	out := new(VaultStaticMeta)
	in.DeepCopyInto(out)
	return out
}
