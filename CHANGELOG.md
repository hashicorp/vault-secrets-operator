...
Dependency Updates:
* Remove the `github.com/aws/aws-sdk-go` (AWS SDK for Go v1) dependency and migrate AWS authentication to AWS SDK for Go v2, bumping `github.com/hashicorp/go-secure-stdlib/awsutil` from `v0.3.0` to `v2.1.2`. AWS auth behavior is unchanged ([#1315](https://github.com/hashicorp/vault-secrets-operator/pull/1315))
